...
public class SimulateTransactionConfig
{
    ...
    public bool SigVerify { get; set; } = false;

    [JsonPropertyName("innerInstructions")] 
    public bool InnerInstructions { get; set; } = false;

    [JsonPropertyName("accounts")] 
    public SimulateTransactionAccountsConfig? Accounts { get; set; }
}
...
{
    [JsonPropertyName("accounts")] 
    public SolanaAccount?[]? Accounts { get; set; }
    ...
    public SimulateTransactionReturnData? ReturnData { get; set; }

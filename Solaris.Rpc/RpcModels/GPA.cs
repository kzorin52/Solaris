...
public class GPASingleResult
{
    ...
    [JsonPropertyName("account")] public required SolanaAccount Account { get; set; }
...
public class GPAFilters
{
    ...
    [JsonPropertyName("commitment")] public string Commitment { get; set; } = "processed";
}
...
public class MemCmpFilterItem
{
    ...
    [JsonPropertyName("bytes")] public required string Bytes { get; set; }
}